...
public class LocalConnectionTest extends LocalConnection {
	...
	public void testLoginLevels() {
		listener=new ClientListener(){
			...
			@Override
			public void exceptionInClientData(TCPClientException e) {				//Darf nicht ausgeführt werden
...
//		sendPacket(packet);
	...
	public void updateCheckedAnswerRight() throws SQLException{
		...
		ResultSet executeQuery = connect.createStatement()
				.executeQuery("select overallCount from question_data");
		assertEquals("22", executeQuery.getString(1));
		executeQuery = connect.createStatement()
				.executeQuery("select falseCount from question_data");
